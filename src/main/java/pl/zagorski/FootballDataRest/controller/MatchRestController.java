...
public class MatchRestController {
    ...
    public MatchWebDto updateMatch(@PathVariable int id, @PathVariable String homeTeam, @PathVariable String awayTeam) throws NotFoundException, NullPointerException {
